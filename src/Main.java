...
public class Main {
    ...
    public static void ukol2() {
        String uzivatel = "Karel";   //String uzivatel = Karel;
        System.out.println(uzivatel);
    }

    public static void ukol3() {
        int pocetLekci = 10;        // String pocetLekci = 10;
        System.out.println(pocetLekci);
    }

    public static void ukol4() {
        double cena = 10.0;          // double cena = 10,0;
        System.out.println(cena);
    }

    public static void ukol5() {       // memory represent numbers in binary(0,1)
...
//    }
    ...
    public static void ukol6() {
        BigDecimal cena = BigDecimal.ZERO;          // I had  to use Java class BigDecimal
    ...
    public static void ukol8() {
        ...
        System.out.println("Velikost košile je: " + velikostKosile +".");   // problem with writing java syntax (, ,  +)
    }

    public static void ukol9() {   // miss static
